...
This project was used to get familiar with PHP/Silex/Twig/PHPUnit and will allow a user to inventory their collection.
...
* `git clone https://github.com/jaredbeckler/collection-inventory-php` this repository
